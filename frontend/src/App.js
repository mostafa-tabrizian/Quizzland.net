...
const SnackbarCloseButton = ({ snackbarKey }) => {
    ...
    return (
      <button onClick={() => closeSnackbar(snackbarKey)} className='absolute left-0 top-4 ml-1'>
    ...
    return (
        <React.Fragment>
            <Suspense
                ...
                <CookiesProvider>  
                    <SnackbarProvider preventDuplicate action={snackbarKey => <SnackbarCloseButton snackbarKey={snackbarKey} />}>
                        <Router>
                            <ScrollToTop />
                            <Header />
