    ...
    return (
        <React.Fragment>
            ...
            <div className='space-y-5 max-w-[40rem] md:mx-auto mx-5 mt-5 mb-20'>
                ...
                <p>
                    کوییزلند ممکن است نقد و کامنت های ارسالی کاربران را در راستای رعایت قوانین وب سایت ویرایش یا حذف کند. کاربران ضمن استفاده از خدمات وب‌سایت کوییزلند، حق ویرایش اطلاعات و استفاده از آنها را در چارچوب فوق‌الذکر به کوییزلند اعطا نموده و حق اعتراض را از خود سلب می‌نمایند.
                </p>
                <p>
