...
class Quizzes_Pointy(models.Model):
    ...
    result_upTo_3 = models.IntegerField(null=False, blank=True, default=None)
    result_title_3 = models.CharField(max_length=200, blank=True, null=False)
    result_text_3 = models.TextField(null=False, blank=True, default=None)
    ...
    result_upTo_4 = models.IntegerField(null=False, blank=True, default=None)
    result_title_4 = models.CharField(max_length=200, blank=True, null=False)
    result_text_4 = models.TextField(null=False, blank=True, default=None)
    ...
    result_upTo_5 = models.IntegerField(null=False, blank=True, default=None)
    result_title_5 = models.CharField(max_length=200, blank=True, null=False)
    result_text_5 = models.TextField(null=False, blank=True, default=None)
    ...
    result_upTo_6 = models.IntegerField(null=False, blank=True, default=None)
    result_title_6 = models.CharField(max_length=200, blank=True, null=False)
    result_text_6 = models.TextField(null=False, blank=True, default=None)
    ...
    result_upTo_7 = models.IntegerField(null=False, blank=True, default=None)
    result_title_7 = models.CharField(max_length=200, blank=True, null=False)
    result_text_7 = models.TextField(null=False, blank=True, default=None)
    ...
    result_upTo_8 = models.IntegerField(null=False, blank=True, default=None)
    result_title_8 = models.CharField(max_length=200, blank=True, null=False)
    result_text_8 = models.TextField(null=False, blank=True, default=None)
    ...
    result_upTo_9 = models.IntegerField(null=False, blank=True, default=None)
    result_title_9 = models.CharField(max_length=200, blank=True, null=False)
    result_text_9 = models.TextField(null=False, blank=True, default=None)
    ...
    result_upTo_10 = models.IntegerField(null=False, blank=True, default=None)
    result_title_10 = models.CharField(max_length=200, blank=True, null=False)
    result_text_10 = models.TextField(null=False, blank=True, default=None)
...
class Quiz_Pointy_Questions(models.Model):
    ...
    option_Point_4 = models.IntegerField(null=False, blank=True, default=None)
    
    option_Value_5 = models.CharField(max_length=100, blank=True)
    option_Point_5 = models.IntegerField(null=False, blank=True, default=None)
    
    option_Value_6 = models.CharField(max_length=100, blank=True)
    option_Point_6 = models.IntegerField(null=False, blank=True, default=None)
    
    option_Value_7 = models.CharField(max_length=100, blank=True)
    option_Point_7 = models.IntegerField(null=False, blank=True, default=None)
    
    option_Value_8 = models.CharField(max_length=100, blank=True)
    option_Point_8 = models.IntegerField(null=False, blank=True, default=None)
    
    option_Value_9 = models.CharField(max_length=100, blank=True)
    option_Point_9 = models.IntegerField(null=False, blank=True, default=None)
    
    option_Value_10 = models.CharField(max_length=100, blank=True)
    option_Point_10 = models.IntegerField(null=False, blank=True, default=None)
