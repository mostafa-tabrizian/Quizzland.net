...
const Quiz = () => {
    ...
    const grabData = () => {
        ...
        const grabQuiz = async () => {
            const quizDB = await axiosInstance.get(`/dbAPI/pointy_new/?title__iexact=${quizTitleReplacedWithHyphen}&limit=1`)
            quiz = quizDB.data.results[0]
            return quiz
        }
        
        const grabQuestions = async () => {
            return await axiosInstance.get(`/dbAPI/questions_pointy/?title__iexact=${quizTitleReplacedWithHyphen}`)
        }
            ...
            return (
                <div className="flex flex-jc-c">
                    <form className='quiz__options quiz__options__text' action="">
                        { question.option_1st !== ('') && <React.Fragment> <input onClick={selectedOption} type="radio" name="answer" id={`${questionCounterForId}-1`} /> <label className={'quiz__options__textLabel'} id={`inputLabel ${questionCounterForId}-1`} htmlFor={`${questionCounterForId}-1`}> { question.option_1st } </label> </React.Fragment> }
                        { question.option_2nd !== ('') && <React.Fragment> <input onClick={selectedOption} type="radio" name="answer" id={`${questionCounterForId}-2`} /> <label className={'quiz__options__textLabel'} id={`inputLabel ${questionCounterForId}-2`} htmlFor={`${questionCounterForId}-2`}> { question.option_2nd } </label> </React.Fragment> }
                        { question.option_3rd !== ('') && <React.Fragment> <input onClick={selectedOption} type="radio" name="answer" id={`${questionCounterForId}-3`} /> <label className={'quiz__options__textLabel'} id={`inputLabel ${questionCounterForId}-3`} htmlFor={`${questionCounterForId}-3`}> { question.option_3rd } </label> </React.Fragment> }
                        { question.option_4th !== ('') && <React.Fragment> <input onClick={selectedOption} type="radio" name="answer" id={`${questionCounterForId}-4`} /> <label className={'quiz__options__textLabel'} id={`inputLabel ${questionCounterForId}-4`} htmlFor={`${questionCounterForId}-4`}> { question.option_4th } </label> </React.Fragment> }
                        { question.option_5th !== ('') && <React.Fragment> <input onClick={selectedOption} type="radio" name="answer" id={`${questionCounterForId}-5`} /> <label className={'quiz__options__textLabel'} id={`inputLabel ${questionCounterForId}-5`} htmlFor={`${questionCounterForId}-5`}> { question.option_5th } </label> </React.Fragment> }
                        { question.option_6th !== ('') && <React.Fragment> <input onClick={selectedOption} type="radio" name="answer" id={`${questionCounterForId}-6`} /> <label className={'quiz__options__textLabel'} id={`inputLabel ${questionCounterForId}-6`} htmlFor={`${questionCounterForId}-6`}> { question.option_6th } </label> </React.Fragment> }
                        { question.option_7th !== ('') && <React.Fragment> <input onClick={selectedOption} type="radio" name="answer" id={`${questionCounterForId}-7`} /> <label className={'quiz__options__textLabel'} id={`inputLabel ${questionCounterForId}-7`} htmlFor={`${questionCounterForId}-7`}> { question.option_7th } </label> </React.Fragment> }
                        { question.option_8th !== ('') && <React.Fragment> <input onClick={selectedOption} type="radio" name="answer" id={`${questionCounterForId}-8`} /> <label className={'quiz__options__textLabel'} id={`inputLabel ${questionCounterForId}-8`} htmlFor={`${questionCounterForId}-8`}> { question.option_8th } </label> </React.Fragment> }
                        { question.option_9th !== ('') && <React.Fragment> <input onClick={selectedOption} type="radio" name="answer" id={`${questionCounterForId}-9`} /> <label className={'quiz__options__textLabel'} id={`inputLabel ${questionCounterForId}-9`} htmlFor={`${questionCounterForId}-9`}> { question.option_9th } </label> </React.Fragment> }
                        { question.option_10th !== ('') && <React.Fragment> <input onClick={selectedOption} type="radio" name="answer" id={`${questionCounterForId}-10`} /> <label className={'quiz__options__textLabel'} id={`inputLabel ${questionCounterForId}-10`} htmlFor={`${questionCounterForId}-10`}> { question.option_10th } </label> </React.Fragment> }
                    </form>
                </div>
            )
        } else {
            return (
                <div className="flex flex-jc-c">
                    <form className='quiz__options quiz__options__img grid flex-jc-c pos-rel' data={question.answer} action="">
                        { !(question.option_img_1st.includes('NotExist')) && <React.Fragment> <input onClick={selectedOption} type="radio" name="answer" id={`${questionCounterForId}-1`} /> <label className={'quiz__options__imgLabel'} id={`inputLabel ${questionCounterForId}-1`} htmlFor={`${questionCounterForId}-1`}> <img className="quiz__imgOption" src={question.option_img_1st} alt={question.title} loading='lazy' /> </label> </React.Fragment> }
                        { !(question.option_img_2nd.includes('NotExist')) && <React.Fragment> <input onClick={selectedOption} type="radio" name="answer" id={`${questionCounterForId}-2`} /> <label className={'quiz__options__imgLabel'} id={`inputLabel ${questionCounterForId}-2`} htmlFor={`${questionCounterForId}-2`}> <img className="quiz__imgOption" src={question.option_img_2nd} alt={question.title} loading='lazy' /> </label> </React.Fragment> }
                        { !(question.option_img_3rd.includes('NotExist')) && <React.Fragment> <input onClick={selectedOption} type="radio" name="answer" id={`${questionCounterForId}-3`} /> <label className={'quiz__options__imgLabel'} id={`inputLabel ${questionCounterForId}-3`} htmlFor={`${questionCounterForId}-3`}> <img className="quiz__imgOption" src={question.option_img_3rd} alt={question.title} loading='lazy' /> </label> </React.Fragment> }
                        { !(question.option_img_4th.includes('NotExist')) && <React.Fragment> <input onClick={selectedOption} type="radio" name="answer" id={`${questionCounterForId}-4`} /> <label className={'quiz__options__imgLabel'} id={`inputLabel ${questionCounterForId}-4`} htmlFor={`${questionCounterForId}-4`}> <img className="quiz__imgOption" src={question.option_img_4th} alt={question.title} loading='lazy' /> </label> </React.Fragment> }
                        { !(question.option_img_5th.includes('NotExist')) && <React.Fragment> <input onClick={selectedOption} type="radio" name="answer" id={`${questionCounterForId}-5`} /> <label className={'quiz__options__imgLabel'} id={`inputLabel ${questionCounterForId}-5`} htmlFor={`${questionCounterForId}-5`}> <img className="quiz__imgOption" src={question.option_img_5th} alt={question.title} loading='lazy' /> </label> </React.Fragment> }
                        { !(question.option_img_6th.includes('NotExist')) && <React.Fragment> <input onClick={selectedOption} type="radio" name="answer" id={`${questionCounterForId}-6`} /> <label className={'quiz__options__imgLabel'} id={`inputLabel ${questionCounterForId}-6`} htmlFor={`${questionCounterForId}-6`}> <img className="quiz__imgOption" src={question.option_img_6th} alt={question.title} loading='lazy' /> </label> </React.Fragment> }
                        { !(question.option_img_7th.includes('NotExist')) && <React.Fragment> <input onClick={selectedOption} type="radio" name="answer" id={`${questionCounterForId}-7`} /> <label className={'quiz__options__imgLabel'} id={`inputLabel ${questionCounterForId}-7`} htmlFor={`${questionCounterForId}-7`}> <img className="quiz__imgOption" src={question.option_img_7th} alt={question.title} loading='lazy' /> </label> </React.Fragment> }
                        { !(question.option_img_8th.includes('NotExist')) && <React.Fragment> <input onClick={selectedOption} type="radio" name="answer" id={`${questionCounterForId}-8`} /> <label className={'quiz__options__imgLabel'} id={`inputLabel ${questionCounterForId}-8`} htmlFor={`${questionCounterForId}-8`}> <img className="quiz__imgOption" src={question.option_img_8th} alt={question.title} loading='lazy' /> </label> </React.Fragment> }
                        { !(question.option_img_9th.includes('NotExist')) && <React.Fragment> <input onClick={selectedOption} type="radio" name="answer" id={`${questionCounterForId}-9`} /> <label className={'quiz__options__imgLabel'} id={`inputLabel ${questionCounterForId}-9`} htmlFor={`${questionCounterForId}-9`}> <img className="quiz__imgOption" src={question.option_img_9th} alt={question.title} loading='lazy' /> </label> </React.Fragment> }
                        { !(question.option_img_10th.includes('NotExist')) && <React.Fragment> <input onClick={selectedOption} type="radio" name="answer" id={`${questionCounterForId}-10`} /> <label className={'quiz__options__imgLabel'} id={`inputLabel ${questionCounterForId}-10`} htmlFor={`${questionCounterForId}-10`}> <img className="quiz__imgOption" src={question.option_img_10th} alt={question.title} loading='lazy' /> </label> </React.Fragment> }
                    </form>
                </div>
            )
        }
