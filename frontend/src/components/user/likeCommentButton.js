    ...
    return (
        <React.Fragment>
            ...
            <div className='flex justify-center w-screen'>
                <div style={{background: `linear-gradient(180deg, black, ${props.quiz?.theme || props.quizDetail?.question_background}`}} className={`${lifelineStatue ? 'pop_up opacity-100' : 'pop_down opacity-0'} rounded-lg shadow-[0_0_15px_black] w-[25rem] p-3 rounded-t-lg-800 fixed bottom-0 z-10`}>
                    <button style={{background: props.quiz?.theme || props.quizDetail?.question_background}} onClick={() => setLifelineStatue(false)} className='absolute top-2 right-2 rounded-full p-[0.1rem] z-20'>
                    ...
                    <div className='relative top-[-3rem] space-y-3'>
                        <div style={{background: props.quiz?.theme || props.quizDetail?.question_background}} className='shadow-[0_0_10px_black] mx-auto mb-4 rounded-full p-3 w-16'>
                            {lifelineIcon}
                        </div>
            ...
            <div className={`${lifeline ? 'pop_up opacity-100' : 'pop_down opacity-0'} fixed z-10 flex justify-center w-screen md:bottom-20 bottom-28`}>
                <div style={{'background': props.quiz?.theme || props.quizDetail?.question_background || '#991b1b'}} className={`flex shadow-[0_0_4px_white] px-4 py-2 space-x-5 rounded-2xl relative`}>
                    ...
                    <div style={{'background': props.quiz?.theme || props.quizDetail?.question_background || '#991b1b'}} className={`${lifeline ? 'pop_up opacity-100' : 'pop_down opacity-0'} absolute top-[-2.5rem] px-3 py-1 left-10 md:left-[2.1rem] rounded`}>
